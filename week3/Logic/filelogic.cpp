...
QString FileLogic::GetDBFolder(const QString strDBName)
{
    ...
    try
    {
        ...
        strFolder=QString("./DBMS_ROOT/data/%1").arg(strDBName);
    }
    catch (AppException* e)
    {
        throw e;
...
QString FileLogic::GetTableFile(const QString strDBName)
{
    ...
    try
    {
        ...
        strPath=QString("./DBMS_ROOT/data/%1/%2.tb").arg(strDBName, strDBName);
    }
    catch (AppException* e)
    {
        throw e;
...
QString FileLogic::GetTbDefineFile(const QString strDBName, const QString strTableName)
{
    ...
    try
    {
        strPath=QString("./DBMS_ROOT/data/%1/%2/%3.tdf").arg(strDBName, strTableName,strTableName);
    }
    catch (AppException* e)
    {
        throw e;
...
QString FileLogic::GetTbRecordFile(const QString strDBName, const QString strTableName)
{
    ...
    try
    {
        strPath=QString("./DBMS_ROOT/data/%1/%2/%3.trd").arg(strDBName, strTableName,strTableName);
    }
    catch (AppException* e)
    {
        throw e;
