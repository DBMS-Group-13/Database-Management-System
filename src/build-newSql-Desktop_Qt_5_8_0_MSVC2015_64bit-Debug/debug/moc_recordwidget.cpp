...
QT_MOC_LITERAL(1, 13, 6), // "hahaha"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 24), // "QHash<int,RecordEntity*>"
QT_MOC_LITERAL(4, 46, 21), // "on_pushButton_clicked"
QT_MOC_LITERAL(5, 68, 26), // "on_tableView_doubleClicked"
QT_MOC_LITERAL(6, 95, 5), // "index"
QT_MOC_LITERAL(7, 101, 20), // "on_tableView_clicked"
QT_MOC_LITERAL(8, 122, 22) // "on_applyButton_clicked"

    },
    "RecordWidget\0hahaha\0\0QHash<int,RecordEntity*>\0"
...
void RecordWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->hahaha((*reinterpret_cast< QHash<int,RecordEntity*>(*)>(_a[1]))); break;
        ...
        {
            typedef void (RecordWidget::*_t)(QHash<int,RecordEntity*> );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RecordWidget::hahaha)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject RecordWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_RecordWidget.data,
      qt_meta_data_RecordWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void RecordWidget::hahaha(QHash<int,RecordEntity*> _t1)
{
